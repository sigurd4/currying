...
#![cfg_attr(all(feature = "rcurry", feature = "8"), doc = r#"A crate for currying functions in rust
...
```"#)]
#![cfg_attr(all(feature = "rcurry", not(feature = "8")), doc = r#"A crate for currying functions in rust
...
assert_eq!(fxyz(), f(x, y, z));
```"#)]
#![cfg_attr(all(not(feature = "rcurry"), feature = "8"), doc = r#"A crate for currying functions in rust
...
```"#)]
#![cfg_attr(all(not(feature = "rcurry"), not(feature = "8")), doc = r#"A crate for currying functions in rust
...
mod test
{
    ...
    #[cfg(all(feature = "rcurry", feature = "8"))]
    #[test]
    fn test_const()
    {
        use crate::*;
